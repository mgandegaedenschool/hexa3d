...
@section('content')
    ...
    <?php if (isset($_GET['part']) && $_GET['part'] == 1){ ?>
        @include('test.irmr3.test_irmr3_formulaire_part1')
    <?php }elseif (isset($_GET['part']) && $_GET['part'] == 2){ ?>
        @include('test.irmr3.test_irmr3_formulaire_part2')
    <?php }elseif (isset($_GET['part']) && $_GET['part'] == 3){ ?>
        @include('test.irmr3.test_irmr3_formulaire_part3')
    <?php }elseif (isset($_GET['part']) && $_GET['part'] == 4){ ?>
        @include('test.irmr3.test_irmr3_formulaire_part4')
    <?php }elseif (isset($_GET['part']) && $_GET['part'] == 5){ ?>
        @include('test.irmr3.test_irmr3_formulaire_part5')
    <?php }elseif (isset($_GET['part']) && $_GET['part'] == 6){ ?>
        @include('test.irmr3.test_irmr3_formulaire_part6')
    <?php }elseif (isset($_GET['part']) && $_GET['part'] == 7){ ?>
        @include('test.irmr3.test_irmr3_formulaire_part7')
    <?php }elseif (isset($_GET['part']) && $_GET['part'] == 8){ ?>
        @include('test.irmr3.test_irmr3_formulaire_part8')
    <?php }elseif (isset($_GET['part']) && $_GET['part'] == 9){ ?>
        @include('test.irmr3.test_irmr3_formulaire_part9')
    <?php } ?>
