    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            {{-- <div>
                ...
                <input id="login" type="text" class="block w-full mt-1" v-model="form.login" required autofocus autocomplete="username" />
            </div> --}}
             ...
             <div>
                ...
                <x-input id="login" class="block mt-1 w-full" type="text" name="login" :value="old('login')" required
                    autofocus placeholder="Votre identifiant ou mail" />
            </div> 
