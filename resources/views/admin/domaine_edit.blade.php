...
@section('content')
    ...
    <main class="dashboard-layout">
        ...
        <div class="top-content p-4 align-items-center">
            ...
            <h1 class="text-center bo-title">Modifier le domaine</h1>
        ...
        <div class="content-container container-fluid">
            <div class="d-flex align-items-center justify-content-between flex-column">
                <h2 class="div-users-title my-5 d-inline-block">Editer un domaine</h2>
                    ...
                    <form action="" method="post" class="px-md-4 px-lg-4">
                        ...
                        <div class="form-row d-flex justify-content-between">
                            <div class="form-group col-12 col-md-5 col-lg-5">
                                <label for="libelle_domaine">Libellé du domaine</label>
                                <input type="text" class="form-control" id="libelle_domaine" placeholder="libelle_domaine">
                            </div>
                            <div class="form-group col-12 col-md-5 col-lg-5">
                                <label for="id_test">Id test</label>
                                <select id="id_test" class="form-control">
