...
@section('content')
    ...
    <main class="dashboard-layout">
        ...
        <div class="top-content p-4 align-items-center">
            ...
            <h1 class="text-center bo-title">Modifier la participation</h1>
        ...
        <div class="content-container container-fluid">
            <div class="d-flex align-items-center justify-content-between flex-column">
                <h2 class="div-users-title my-5 d-inline-block">Editer une participation</h2>
                    ...
                    <form action="" method="post" class="px-md-4 px-lg-4">
                        ...
                        <div class="form-row d-flex justify-content-between">
                            <div class="form-group col-12 col-md-5 col-lg-5">
                                ...
                                <input type="date" class="form-control" id="InputId" placeholder="identifiant ou adresse mail">
                            </div>
                            <div class="form-group col-12 col-md-5 col-lg-5">
                                <label for="idTest">Id du test</label>
                        ...
                        <div class="form-row d-flex justify-content-between">
                            ...
                            <div class="form-group col-12 col-md-5 col-lg-5">
                                <label for="idEta">Id etalonnage defaut</label>
                                <select class="form-control" id="idEta">
                                    <option value="1">1</option>
                                </select>
                            </div>
                        </div>
