...
@section('content')
    ...
    <main class="dashboard-layout">
        ...
        <div class="top-content p-4 align-items-center">
            ...
            <h1 class="text-center bo-title">Accueil des questions</h1>
        ...
        <div class="content-container container-fluid">
            <div class="d-flex align-items-center justify-content-between flex-column flex-md-row flex-lg-row">
                <h2 class="div-title my-5 d-inline-block">Table des questions</h2>
                @include('admin.question_create_inc')
            </div>
            ...
            <div class="d-flex w-100 justify-content-center">
                <table class="table table-hover w-auto table-bordered table-users table-responsive mb-0">
                    ...
                    <tr>
                        ...
                        <th scope="col">id_item_hexa3d</th>
                        <th scope="col">id_test</th>
                        <th scope="col">id_partie</th>
                        <th scope="col">id_domaine</th>
                        <th scope="col">ordre</th>
                        <th scope="col">type_riarsec</th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
                        <td class="no-defil">
                            <a href="{{route('admin.question_show')}}"><i class="far fa-eye user-tab-icon"></i></a>
                            <a href="{{route('admin.question_edit')}}"><i class="fas fa-pen user-tab-icon"></i></a>
