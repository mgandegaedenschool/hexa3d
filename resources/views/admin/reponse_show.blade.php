...
@section('content')
    ...
    <main class="dashboard-layout">
        <div class="top-content p-4 align-items-center">
            ...
            <h1 class="text-center bo-title">Détails de la réponse</h1>
        ...
        <div class="content-container container-fluid">
            <div class="d-flex align-items-center justify-content-between flex-column">
                <h2 class="div-users-title my-5 d-inline-block">Informations réponse</h2>
                ...
                <div class="container-fluid mb-5">
                    <div class="dropped-information d-flex flex-wrap flex-column flex-lg-row row">
                        ...
                        <div class="container-fluid">
                            <a href="{{route('admin.reponse_edit')}}" class="btn purple-btn edit-btn send-password-link-btn py-2 px-4 mt-4">Modifier</a>
                        </div>
                    </div>
                </div>
            </div>
