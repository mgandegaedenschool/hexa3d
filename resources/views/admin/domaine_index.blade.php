    ...
    <main class="dashboard-layout">
        ...
        <div class="content-container container-fluid">
            <div class="d-flex align-items-center justify-content-between flex-column flex-md-row flex-lg-row">
                <h2 class="div-title my-5 d-inline-block">Table des domaines</h2>
                @include('admin.domaine_create_inc')
            </div>
            ...
            <div class="d-flex w-100 justify-content-center">
                <table class="table table-hover w-auto table-bordered table-users table-responsive mb-0">
                    ...
                    <tr>
                        <td class="no-defil">
                            <a href="{{route('admin.domaine_show')}}"><i class="far fa-eye user-tab-icon"></i></a>
                            <a href="{{route('admin.domaine_edit')}}"><i class="fas fa-pen user-tab-icon"></i></a>
