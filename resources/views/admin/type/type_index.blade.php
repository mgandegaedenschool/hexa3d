...
@section('content')
    ...
    <main class="dashboard-layout">
        ...
        <div class="top-content p-4 align-items-center">
            ...
            <h1 class="text-center bo-title">Accueil des types</h1>
        ...
        <div class="content-container container-fluid">
            <div class="d-flex align-items-center justify-content-between flex-column flex-md-row flex-lg-row">
                <h2 class="div-title my-5 d-inline-block">Table des types</h2>
                @include('admin.type_create_inc')
            </div>
            ...
            <div class="d-flex w-100 justify-content-center">
                <table class="table table-hover w-auto table-bordered table-users table-responsive mb-0">
                    ...
                    <tr>
                        ...
                        <th scope="col">libelle_type</th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
                        <td class="no-defil">
                            <a href="{{route('admin.type_show')}}"><i class="far fa-eye user-tab-icon"></i></a>
                            <a href="{{route('admin.type_edit')}}"><i class="fas fa-pen user-tab-icon"></i></a>
