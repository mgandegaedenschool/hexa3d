<div class="modal fade" id="proImportModalTest" tabindex="-1" aria-labelledby="proImportModalTest" aria-hidden="true">
                        ...
                        <div class="form-row d-flex justify-content-between flex-direction-column">
                            <div class="form-group col-12">
                                ...
                                <div class="imported-invite d-flex justify-content-center my-5">
                                    ...
                                    <button type="submit" class="purple-btn espace-pro-purple-btn px-5 py-2 button-import-invite" data-toggle="modal" data-target="#proImportModalTest" name="options" value="oui">Oui</button>
